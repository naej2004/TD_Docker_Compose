...
- Conteneur nommé `wordpress_app`
- Dépend du service `db` (grâce à `depends_on`)
- Accessible à l'adresse `http://localhost:8080` (port mappé)
...
> Avant de commencer, assurez-vous que **Docker** et **Docker Compose** sont bien installés sur votre machine.
